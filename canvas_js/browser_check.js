...
var showBrowserInfo = function() {
    ...
    //  - Changing to execute on 'User Dashboard' only
    //  - Cannot change until placed at highest level. 
    //      User dashboard page executes js from top level only
    // 6-29-2017
    //  - Setting to load only on the homepage for a course
    //       /course/#####$/
